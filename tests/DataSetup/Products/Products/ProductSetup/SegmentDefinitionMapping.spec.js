...
test.describe(' Segment Definition Mapping - Create Multiple Segment Maps', () => {
...
const segmentDefinition = poManager.getSegmentDefinitionMappingPage();
await segmentDefinition.navigateToSegmentDefinitionMapping();
await segmentDefinition.createSegmentDefinitionMapping(data.segmentName, data.DataSourceType);
